...
public class PostResponse {
    ...
    public static class DetailDTO {
        ...
        private final List<PictureResponse.DTO> pictures;
        private final CommentResponse.CommentsList comments;
        private final Integer likeCount;
        private final Integer commentCount;
        private final Boolean isLiked;
        private final LocalDateTime createdAt;
        ...
        public DetailDTO(Post post, CommentResponse.CommentsList comments, List<PostPicture> postPictures, Integer likeCount, Integer commentCount, Boolean isLiked) {
            this.id = post.getId();
            this.content = post.getContent();
