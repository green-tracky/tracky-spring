...
INSERT INTO user_tb (login_id, password, username, email, profile_url, height, weight, gender, location, letter,
                     user_type, provider, user_tag,
                     flutter_token_id, created_at, run_level_id)
VALUES ('cos', 'password123', 'cos', 'cos@example.com', 'http://example.com/profiles/cos.jpg', 168.0, 60.0, 'FEMALE',
...
INSERT INTO user_tb (login_id, password, username, email, profile_url, height, weight, gender, location, letter,
                     user_type, provider, user_tag,
                     flutter_token_id, created_at, run_level_id)
VALUES ('love', 'password123', 'love', 'love@example.com', 'http://example.com/profiles/love.jpg', 160.0, 55.0,
...
INSERT INTO user_tb (login_id, password, username, email, profile_url, height, weight, gender, location, letter,
                     user_type, provider, user_tag,
                     flutter_token_id, created_at, run_level_id)
VALUES ('haha', 'password123', 'haha', 'haha@example.com', 'http://example.com/profiles/haha.jpg', 180.0, 75.0, 'MALE',
...
INSERT INTO user_tb (login_id, password, username, email, profile_url, height, weight, gender, location, letter,
                     user_type, provider, user_tag,
                     flutter_token_id, created_at, run_level_id)
VALUES ('green', 'password123', 'green', 'green@example.com', 'http://example.com/profiles/green.jpg', 165.0, 58.0,
...
INSERT INTO user_tb (login_id, password, username, email, profile_url, height, weight, gender, location, letter,
                     user_type, provider, user_tag,
                     flutter_token_id, created_at, run_level_id)
VALUES ('leo', 'password123', 'leo', 'leo@example.com', 'http://example.com/profiles/leo.jpg', 172.0, 68.0, 'MALE',
