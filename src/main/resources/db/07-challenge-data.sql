...
VALUES ('6월 15k 챌린지', '6월 한 달 동안 15km를 달성해보세요!', '꾸준함이 실력! 6월 한 달 동안 10km를 달성하고 성취감을 느껴보세요.',
        '2025-06-01 00:00:00', '2025-06-30 23:59:59', 10000, true, 1, NOW(), 'PUBLIC',
...
INSERT INTO challenge_tb (name, sub, description, start_date, end_date, target_distance, is_in_progress, creator_id,
                          created_at, type, image_url, challenge_year, challenge_month, week_of_month, period_type)
VALUES ('가볍게 1km 달리기', '', '', '2025-06-15 00:00:00', '2025-06-15 23:59:59', 1000, true, 1, NOW(), 'PRIVATE',
        null, 2025, 6, 3, 'WEEKLY');
