...
INSERT INTO public_challenge_tb (id, reward_name, reward_image_url)
...
INSERT INTO challenge_tb (name, sub, description, start_date, end_date, target_distance, is_in_progress, creator_id,
                          created_at, challenge_type)
VALUES ('6월 10km 도전!', '6월 한 달 동안 10km를 달성해보세요!', '꾸준함이 실력! 6월 한 달 동안 10km를 달성하고 성취감을 느껴보세요.', '2025-06-01 00:00:00',
        '2025-07-30 23:59:59', 10000, true, 1, NOW(), 'PUBLIC');
-- 자식 테이블
INSERT INTO public_challenge_tb (id, reward_name, reward_image_url)
...
INSERT INTO challenge_tb (name, sub, description, start_date, end_date, target_distance, is_in_progress, creator_id,
                          created_at, challenge_type)
VALUES ('6월 15km 챌린지', '6월 한 달 동안 15km를 달성해보세요!', '이제 당신도 러너! 15km의 거리를 정복하고 특별한 보상을 받으세요.',
        '2025-06-01 00:00:00', '2025-07-30 23:59:59', 15000, true, 1, NOW(), 'PUBLIC');
-- 자식 테이블
INSERT INTO public_challenge_tb (id, reward_name, reward_image_url)
...
INSERT INTO challenge_tb (name, sub, description, start_date, end_date, target_distance, is_in_progress, creator_id,
                          created_at, challenge_type)
VALUES ('6월 50km 챌린지', '6월 한 달 동안 50km를 달성해보세요!', '인내와 열정의 상징, 50km 완주에 도전하고 당신의 한계를 증명하세요.',
        '2025-06-01 00:00:00', '2025-07-30 23:59:59', 50000, true, 1, NOW(), 'PUBLIC');
-- 자식 테이블
INSERT INTO public_challenge_tb (id, reward_name, reward_image_url)
...
INSERT INTO challenge_tb (name, sub, description, start_date, end_date, target_distance, is_in_progress, creator_id,
                          created_at, challenge_type)
VALUES ('6월 100km 챌린지', '6월 한 달 동안 100km를 달성해보세요!', '상위 1%를 위한 궁극의 도전! 100km를 완주하고 명예의 전당에 오르세요.',
        '2025-06-01 00:00:00', '2025-07-30 23:59:59', 100000, true, 1, NOW(), 'PUBLIC');
-- 자식 테이블
INSERT INTO public_challenge_tb (id, reward_name, reward_image_url)
...
INSERT INTO challenge_tb (name, sub, description, start_date, end_date, target_distance, is_in_progress, creator_id,
                          created_at, challenge_type)
VALUES ('가볍게 1km 달리기', '', '', '2025-06-15 00:00:00',
