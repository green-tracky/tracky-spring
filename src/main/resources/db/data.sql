...
(4, '브론즈', '총 러닝 거리 10km를 달성했어요!', 'https://example.com/badges/bronze.png'),
(5, '실버', '총 러닝 거리 20km를 달성했어요!', 'https://example.com/badges/silver.png'),
(6, '골드', '총 러닝 거리 40km를 달성했어요!', 'https://example.com/badges/gold.png'),
(7, '플래티넘', '총 러닝 거리 80km를 달성했어요!', 'https://example.com/badges/platinum.png');