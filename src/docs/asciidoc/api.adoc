...
=== 2. 포스트 목록 조회 실패 (인증 없음)
===== Request Example
include::{snippets}/{post}/get_posts_fail_test/http-request.adoc[]

===== Response Example
include::{snippets}/{post}/get_posts_fail_test/http-response.adoc[]
...
===== Request Example
include::{snippets}/{challengeinvite}/friend_inviteReject_fail_test/http-request.adoc[]

===== Response Example
include::{snippets}/{challengeinvite}/friend_inviteReject_fail_test/http-response.adoc[]
